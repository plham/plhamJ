...
public class ShockTransferMain extends samples.CI2002.CI2002Main implements
		x10.serialization.X10JavaSerializable {
	public static final x10.rtt.RuntimeType<ShockTransferMain> $RTT = x10.rtt.NamedType
			.<ShockTransferMain> make(
					"samples.ShockTransfer.ShockTransferMain",
					ShockTransferMain.class,
					new x10.rtt.Type[] { samples.CI2002.CI2002Main.$RTT });
	...
	public static x10.serialization.X10JavaSerializable $_deserialize_body(
			samples.ShockTransfer.ShockTransferMain $_obj,
		...
		if (x10.runtime.impl.java.Runtime.TRACE_SER) {
			x10.runtime.impl.java.Runtime
					.printTraceMessage("X10JavaSerializable: $_deserialize_body() of "
							+ ShockTransferMain.class + " calling");
		}
	...
	public static x10.serialization.X10JavaSerializable $_deserializer(
			x10.serialization.X10JavaDeserializer $deserializer)
			throws java.io.IOException {
		samples.ShockTransfer.ShockTransferMain $_obj = new samples.ShockTransfer.ShockTransferMain(
	...
	public static void main(final x10.core.Rail<java.lang.String> args) {
		...
		final samples.ShockTransfer.ShockTransferMain sim = ((new samples.ShockTransfer.ShockTransferMain(
				(java.lang.System[]) null)
				.samples$ShockTransfer$ShockTransferMain$$init$S()));

		// #line 22 "samples/ShockTransfer/ShockTransferMain.x10"
		plham.agent.FCNAgent.register(((sim)));
		...
		// #line 29 "samples/ShockTransfer/ShockTransferMain.x10"
		final plham.main.SequentialRunner t$20386 = ((new plham.main.SequentialRunner<samples.ShockTransfer.ShockTransferMain>(
				(java.lang.System[]) null,
				samples.ShockTransfer.ShockTransferMain.$RTT)
				.init(sim,
				(plham.main.SequentialRunner.sequentialRunner) null)));

		// #line 29 "samples/ShockTransfer/ShockTransferMain.x10"
		((plham.main.Runner<samples.ShockTransfer.ShockTransferMain>) t$20386)
				.run(((args)));
	}
	...
	public void print(final java.lang.String sessionName) {
		...
		final x10.util.List markets = this
				.getMarketsByName((("markets")));

		// #line 34 "samples/ShockTransfer/ShockTransferMain.x10"
		final x10.util.ListIterator market$20416 = (((x10.util.List<plham.Market>) markets)
				.iterator());
		...
		for (; true;) {
			...
			// #line 34 "samples/ShockTransfer/ShockTransferMain.x10"
			final boolean t$20417 = ((x10.util.ListIterator<plham.Market>) market$20416)
					.hasNext$O();
			...
			// #line 34 "samples/ShockTransfer/ShockTransferMain.x10"
			final plham.Market market$20401 = ((((x10.util.ListIterator<plham.Market>) market$20416)
					.next$G()));
			...
			final boolean t$20404 = plham.IndexMarket.$RTT
					.isInstance(market$20401);

			// #line 37 "samples/ShockTransfer/ShockTransferMain.x10"
			if (t$20404) {

				// #line 38 "samples/ShockTransfer/ShockTransferMain.x10"
				final plham.IndexMarket t$20405 = ((x10.rtt.Types
						.<plham.IndexMarket> cast(market$20401,
								plham.IndexMarket.$RTT)));

				// #line 38 "samples/ShockTransfer/ShockTransferMain.x10"
				final double t$20406 = t$20405.getIndex$O((t$20402));
			...
			final x10.io.Printer t$20407 = ((x10.io.Console
					.get$OUT()));
			...
			final java.lang.String t$20409 = ((market$20401.name));

			// #line 45 "samples/ShockTransfer/ShockTransferMain.x10"
			final double t$20410 = market$20401.getPrice$O((t$20402));

			// #line 46 "samples/ShockTransfer/ShockTransferMain.x10"
			final double t$20411 = market$20401
					.getFundamentalPrice((t$20402));

			// #line 47 "samples/ShockTransfer/ShockTransferMain.x10"
			final double t$20412 = marketIndex$20403;

			// #line 40 "samples/ShockTransfer/ShockTransferMain.x10"
			final x10.core.Rail t$20413 = ((x10.runtime.impl.java.ArrayUtils
					.<java.lang.Object> makeRailFromJavaArray(
							x10.rtt.Types.ANY, new java.lang.Object[] {
									sessionName, t$20402, t$20408, t$20409,
									t$20410, t$20411, t$20412, "", "" })));

			// #line 48 "samples/ShockTransfer/ShockTransferMain.x10"
			final int t$20414 = java.lang.Integer.MAX_VALUE;

			// #line 40 "samples/ShockTransfer/ShockTransferMain.x10"
			final java.lang.String t$20415 = x10.util.StringUtil
					.<java.lang.Object> formatArray__0$1x10$util$StringUtil$$T$2(
							x10.rtt.Types.ANY, ((t$20413)),
							((" ")),
							(("")), (t$20414));

			// #line 40 "samples/ShockTransfer/ShockTransferMain.x10"
			t$20407.println(((t$20415)));
		}
	}
