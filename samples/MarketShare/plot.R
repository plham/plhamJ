...
lines(data$price[data$market.name == 'Market-A'], col='red')
lines(data$price[data$market.name == 'Market-B'], col='green')
lines(data$fundam[data$market.name == 'Market-A'], col='black')
lines(data$fundam[data$market.name == 'Market-B'], col='black')
