...
public class IT_GlbRunner_NoLifeline extends PlhamOutputTester {
    ...
    public IT_GlbRunner_NoLifeline(String name, Class<?> mainClass, String jsonFile, String seed, String expectedFileOutput, String warmupJson) {
    ...
    public static void beforeClass() {
        TeamedPlaceGroup.getWorld().broadcastFlat(()->{
            ...
            System.setProperty(GlbRunner.LIFELINE_CLASS, NoLifeline.class.getCanonicalName());
        });
    }
