...
public class IT_SequentialRunner extends PlhamOutputTester {
    ...
    public static Collection<Object[]> constructorParameters() {
        return Arrays.asList(new Object [][]{
            {CI2002Main.class, "src/test/resources/CI2002/config.json", "100", "src/test/resources/CI2002/correct_output.txt"},
            {NewCI2002Main.class, "src/test/resources/CI2002/config.json", "100", "src/test/resources/CI2002/correct_output.txt"},
            {CancelTestMain.class, "src/test/resources/CancelTest/config.json", "100", "src/test/resources/CancelTest/correct_output.txt"},
            {MarketShareMain.class, "src/test/resources/MarketShare/config.json", "100", "src/test/resources/MarketShare/correct_output.txt"},
            {FatTailMain.class, "src/test/resources/FatTail/config.json", "100", "src/test/resources/FatTail/correct_output.txt"},
            {TradingHaltMain.class, "src/test/resources/TradingHalt/config.json", "100", "src/test/resources/TradingHalt/correct_output.txt"},
            {ShockTransferMain.class, "src/test/resources/ShockTransfer/config.json", "100", "src/test/resources/ShockTransfer/correct_output.txt"},
            {PriceLimitMain.class, "src/test/resources/PriceLimit/config.json", "100", "src/test/resources/PriceLimit/correct_output.txt"},
