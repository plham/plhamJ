...
/**
 * A base class for execution models. See {@link plham.core.main.SimulatorFactory} for simulation models. This class is
...
//		sim = s;
    ...
    /**
     * Run the simulation with which the runner was constructed, calling the provided {@link Simulator}'s output methods
