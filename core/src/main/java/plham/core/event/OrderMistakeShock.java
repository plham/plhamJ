...
/**
 * This suddenly changes the market price as a consequence of a fat finger error, e.g., caused by an huge amount of
 * orders at an extremely cheap or expensive price.
 */
