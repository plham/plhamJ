...
public class OrderBook implements Serializable {
	...
	/**
	 * Removes all Orders from this OrderBook which satisfy the predicate given as
	 * parameter, that is, if applying the provided lambda expression on the orders
	 * contained by this instance returns true. The "removed" {@link Order}
	 * instances will be placed
	 *
	 * @param condition the condition under which an Order should be removed
	 * @return {@code true} if at least one Order was removed during this method,
