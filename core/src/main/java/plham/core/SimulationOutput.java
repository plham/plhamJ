...
public class SimulationOutput implements Serializable {
     ...
     * @param agents
     * @deprecated instead of overriding this method, consider using
     *             {@link #agentOutput(OutputCollector, SimulationStage, Agent)},
     *             {@link #marketOutput(OutputCollector, SimulationStage, Market)},
     *             {@link #sessionOutput(OutputCollector, SimulationStage, Session)} and
     *             {@link #eventOutput(OutputCollector, SimulationStage, Event)}
     */
    @Deprecated
    ...
    /**
     * Method called at the beginning of the simulation. By default, calls on methods
     * {@link #marketOutput(OutputCollector, SimulationStage, Market)} and
     * {@link #agentOutput(OutputCollector, SimulationStage, Agent)} for all markets and agents participating in the
     * computation.
     *
     * @deprecated instead of overriding this method, consider using
     *             {@link #agentOutput(OutputCollector, SimulationStage, Agent)},
    ...
    /**
     * Method called at the end of a session that holds the "withprint" operation. By default this method calls method
     * {@link #sessionOutput(OutputCollector, SimulationStage, Session)} with the session that has just ended, and
     * method {@link #marketOutput(OutputCollector, SimulationStage, Market)} and
     * {@link #agentOutput(OutputCollector, SimulationStage, Agent)} for every market and every agent taking part in the
     * computation.
     *
    ...
    /**
     * Allows for information about markets to be logged. By default does not log anything. Override this method to log
     * information into the provided {@link OutputCollector}.
     *
     * @param out
     * @param stage
     * @param m
    ...
    /**
     * Allows for information about order submission to be logged. By default does not log anything. Override this
     * method to log information into the provided {@link OutputCollector}.
     *
     * @param out
     * @param stage
     * @param a
     ...
     * <p>
     * By default, prints the contents stored using method {@link OutputCollector#log(String, Object)} in the previous
     * stage. Override this method if you want to make outputs combining information from multiple participants in the
     * simulation.
     *
